...
(function () {
  ...
  function wrapSelect(sel) {
    ...
    function updateDisplay() {
      ...
      display.textContent = (opt && opt.text) ? opt.text.trim() : (sel.placeholder || '—');
    }
    ...
    function buildList() {
      ...
      function addOption(o) {
        ...
        item.style.cssText = 'padding:8px 10px; cursor:pointer; color:#fff; font-size:12px; white-space:nowrap; overflow:hidden; text-overflow:ellipsis;';
    ...
    selObs.observe(sel, { childList: true, subtree: true });
  }
